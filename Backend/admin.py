...
from .models import Miss_Food_Application, Work_Item_Number,AnnualLeave,Salary, LaborHealthInfo,ReferenceTable,ExtraWorkDay,Travel_Application,SalaryDetail,Clock_Correction_Application,Work_Overtime_Application,SysMessage, Leave_Param, Leave_Application,Quotation,Work_Item, Employee,Equipment,UploadedFile, Approval_Target,ApprovalModel,ApprovalLog,Department, Project_Job_Assign, Project_Confirmation, Clock,News, Project_Employee_Assign,Vehicle,Client
...
class MyUserAdmin(UserAdmin):
    ...
    list_display = ('username','email', 'is_active','is_superuser')  # 添加这行
#
# 工項管理
...
admin.site.register(Miss_Food_Application)
